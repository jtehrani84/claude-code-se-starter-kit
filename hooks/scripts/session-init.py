...
ROUTING_TABLE = {
    ...
    "directories": {
        "apex": ["wiki/concepts/apex-patterns.md"],
        "lwc": ["wiki/concepts/lwc-standards.md"],
        "flow": ["wiki/concepts/flow-patterns.md"],
        "integration": ["wiki/concepts/integration-patterns.md"],
    },
    # If git branch name contains these keywords, suggest these pages
    "branches": {
        "feature": [],
        "fix": [],
        "demo": ["wiki/concepts/demo-standards.md"],
    },
}
