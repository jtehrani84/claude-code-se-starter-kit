...
If the user has mentioned today's meetings or if there's a calendar integration:
- What meetings are today?
- Which accounts need prep?
...
- [Second priority]
- [Meeting prep needed for: [account names]]
...
- "Run /account-prep [company] for your 10am meeting?"
