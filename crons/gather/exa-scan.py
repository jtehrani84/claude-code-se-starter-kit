#!/usr/bin/env python3
"""
Exa Intelligence Gather — Daily automated research scan.
...
Schedule: Daily at 4:30 AM via launchd (see plists/com.claude.gather.exa.plist)

Customize QUERIES below for your territory, accounts, and competitive landscape.
"""
...
# Replace with your accounts, competitors, and focus areas
QUERIES = [
    {
        "label": "account_news",
        "query": "Salesforce enterprise customer news announcements",
        "category": "company",
        "num_results": 5,
        "start_published_date": None,  # Will be set to 24h ago
    },
    {
        "label": "competitor_launches",
        "query": "ServiceNow OR Microsoft Copilot OR Workday AI agent product launch",
        "category": "news",
        "num_results": 5,
        "start_published_date": None,
    },
    {
        "label": "salesforce_product",
        "query": "Salesforce Agentforce OR Data Cloud OR Einstein new feature announcement",
        "category": "news",
        "num_results": 5,
        "start_published_date": None,
    },
    {
        "label": "industry_trends",
        "query": "enterprise AI agents deployment production results",
    ...
    },
    {
        ...
        "query": "Claude Anthropic MCP tool use enterprise integration",
        "category": "tweet",
        "num_results": 5,
        "start_published_date": None,
    },
...
def main():
    ...
    all_results = []
    all_results.append(f"# Exa Intelligence Scan: {today}\n")
    ...
    # Write output
    output_path = os.path.join(RAW_DIR, f"exa-{today}.md")
